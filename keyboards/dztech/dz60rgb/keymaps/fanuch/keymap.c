...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        CTL_T(KC_ESC), KC_A,    KC_S,            KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    LT(1,KC_SCLN)    LT(2,KC_QUOT)   KC_ENT,
    ...
    [1] = LAYOUT(
        ...
        _______, _______, KC_UP,   _______, _______, _______, KC_CALC, _______, KC_INS,  KC_PSCR, KC_SLCK, KC_PAUS, _______, QK_BOOT,
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, KC_HOME, KC_PGUP, _______, _______,          EEP_RST,
